          ...
          ? SafeArea(
              child: Center(
                child: Column(
                  ...
                  children: <Widget>[
                    Image(image: AssetImage('assets/face_logo.png')),
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            "A project application submitted to the Department of Computer Science and Engineering, Jahangirnagar University",
                            style: TextStyle(
                              fontSize: 16,
                            ),
                            textAlign: TextAlign.center,
